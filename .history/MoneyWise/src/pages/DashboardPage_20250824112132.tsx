...
const DashboardPage = () => {
    // Nouveaux états pour le suivi des variations et pour afficher le pourcentage
    const [showVariation, setShowVariation] = useState(false);
    const [showExpensePercentage, setShowExpensePercentage] = useState(false);

    // Valeurs utilisées pour le calcul du pourcentage
    ...
    return (
        <AppLayout title="Tableau de bord">
            <div className="space-y-8">
                ...
                {/* Bouton pour afficher/masquer les variations */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <StatCard
                        ...
                        // Ici, on affiche un bouton plus qui lorsque cliqué affiche en pourcentage les dépenses par rapport aux revenus
                        value={
                            <>
