  ...
  return (
    <div className="bg-background-surface p-6 rounded-lg border border-border">
      ...
      <div className="mt-4 text-sm text-text-secondary">
        <p>
          Visualisation comparative des revenus et dépenses sur différentes périodes. 
          Utilisez les contrôles ci-dessus pour changer la période ou le type de graphique.
        </p>
      </div>
    </div>
  );
