      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="p-6">
            ...
            {variationChartData.length === 0 && (
              <div className="text-center text-gray-500">Aucune donnée pour cette période.</div>
                        )}
                      </div>
                      </div>
                    </div>
