...
export function FinanceProvider({ children }: { children: React.ReactNode }) {
  ...
  }, []);// Les transactions et catégories sont gérées côté API, il n'y a plus de synchronisation avec localStorageconst addTransaction = async (transactionData: Omit<Transaction, 'id' | 'userId'>) => {
    try {
