...
import { Home, LineChart, LogOut, Wallet, Menu, PiggyBank, Settings, Tag, Download,Target} from 'lucide-react';
        ...
        <div className="flex flex-col h-full">
            ...
            <nav className="mt-4 px-2 flex-1">
                <ul className="space-y-1">
                    ...
                    <NavLink to="/budgets" icon={<PiggyBank size={20} />} onClick={onLinkClick}>Budgets</NavLink>
                    <NavLink to="/goals" icon={<Target size={20} />} onClick={onLinkClick}>Objectifs Epargne</NavLink>
